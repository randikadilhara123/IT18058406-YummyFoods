    ...
    <div>
      <div className="flex items-center px-3 py-2 rounded-b-lg bg-gray-50">
        ...
        <textarea
          ...
          value={comment}
          className="block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300  dark:bg-gray-100 dark:border-gray-200 dark:placeholder-gray-400 "
