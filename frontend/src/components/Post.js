...
const Post = props => {
  ...
  return (
    <div className="editor mx-auto my-6 w-10/12 flex flex-col border border-gray-100 max-w-2xl">
      <article className="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
        ...
        <div className="bg-white p-4 sm:p-6">
          ...
          <div className="mt-2 text-start text-sm/relaxed text-gray-500">
            <label>Price :</label>
            {props.price} LKR
          </div>
        ...
        <div className="count ml-auto">
          <div className="buttons flex-none w-14 h-14">
            <div
      ...
      {orderModalOpen && (
        <CreateOrderModal
          ...
          reFetchPost={props.refetchPosts}
        />
      )}
    </div>
  );
